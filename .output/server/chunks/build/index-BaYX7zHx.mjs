...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container" }, _attrs))}><div><div><h1>Systems</h1><p>Every single one of them.</p><hr></div></div><div><div><ul><!--[-->`);
      ssrRenderList(unref(allSystems), (system, index) => {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(system.title)} <sup${_scopeId}> [${ssrInterpolate(system.linkedFrom.gameCollection.total)}]</sup>`);
            } else {
              return [
...
//# sourceMappingURL=index-BaYX7zHx.mjs.map
