...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="container"><div><div><h1>Stats</h1></div></div><div><div><h2>Games</h2><p><b>Total:</b> ${ssrInterpolate(unref(stats).games.total)}</p><div id="games-played-status-chart"></div></div><div><h2>Systems</h2><p><b>Total:</b> ${ssrInterpolate(unref(stats).systems.total)}</p><div id="systems-totals-chart"></div></div></div></div></div>`);
    };
  }
};
...
//# sourceMappingURL=index-dbYi-P-P.mjs.map
